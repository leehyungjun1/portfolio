                            ...
                            <div class="card-body">
                                ...
                                <form wire:submit.prevent="addProduct">
                                    ...
                                    <div class="md-3 mt-3 mb-3">
                                        ...
                                        <textarea class="form-control" name="short_description" placeholder="Enter Description" wire:model="description"> </textarea>
                                    ...
                                    <div class="md-3 mt-3 mb-3">
                                        ...
                                        <textarea class="form-control" name="regular_price" placeholder="Enter Regular Price" wire:model="regular_price"> </textarea>
                                    ...
                                    <div class="md-3 mt-3 mb-3">
                                        ...
                                        <textarea class="form-control" name="sale_price" placeholder="Enter Sale Price" wire:model="sale_price"> </textarea>
                                    ...
                                    <div class="md-3 mt-3 mb-3">
                                        ...
                                        <textarea class="form-control" name="sku" placeholder="Enter sku" wire:model="sku"> </textarea>
